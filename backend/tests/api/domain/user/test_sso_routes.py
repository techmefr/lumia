...
async def test_a_half_configured_instance_returns_404_rather_than_failing(
    ...
    # A state is required now, and a missing one is a 422 before the instance is even read.
    # What this test is about is the half-filled configuration, so the request itself has to
    # be valid.
